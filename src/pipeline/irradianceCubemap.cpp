...
void IrradianceCubemapPipeline::CreatePipeline()
{
    ...
    shader.vertexShaderModule = vkn::Shader::CreateModule("shader/irradiance.vert.spv");
    shader.fragmentShaderModule = vkn::Shader::CreateModule("shader/irradiance.frag.spv");
