#include "shadowCubemapPipeline.h"
...
void ShadowCubemapPipeline::CreatePipeline()
{
    ...
    m_shaderModule.m_vertexShaderModule = vkn::Shader::CreateModule("shader/spv/pointlightshadow.vert.spv");
    m_shaderModule.m_fragmentShaderModule = vkn::Shader::CreateModule("shader/spv/pointlightshadow.frag.spv");
